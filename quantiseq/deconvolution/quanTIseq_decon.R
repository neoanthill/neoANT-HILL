...
source("/home/biodocker/quantiseq/deconvolution/DOCKER_codes.R")
...
if (signame %in% listsig) {
  ...
  sig.mat.file<-file.path("/home/biodocker/quantiseq/deconvolution/",
                          paste0(signame, "_signature.txt"))
  
  mRNA.file<-file.path("/home/biodocker/quantiseq/deconvolution/",
                       paste0(signame, "_mRNA_scaling.txt"))
  
  fileab<-file.path("/home/biodocker/quantiseq/deconvolution/",
    paste0(signame,"_TCGA_aberrant_immune_genes.txt"))
  
  if (rmgenes=="default") {
    filerm<-file.path("/home/biodocker/quantiseq/deconvolution/",
