...
mapGenes<-function(mydata) {
  ...
  HGNC<-read.csv("/home/biodocker/quantiseq/deconvolution/HGNC_genenames_20170418.txt", header=TRUE, sep="\t")
...
celldensities <- function(DCres){
  ...
  imageinfo <- read.csv("/home/biodocker/quantiseq/deconvolution/totalcells.txt", header=FALSE, sep="\t", stringsAsFactors = FALSE)
